...
namespace BlazorDapperSPA.Data
{
    public class EmployeeService : IEmployeeService
    {
        ...
        //{
        //    // Uisng storeProcedure from Db

        //    var parameters = new DynamicParameters();  // part of Dapper Library
        ...
        public async Task<bool> CreateEmployee(Employee employee)
        {
            ...
            // Insert into table using Raw SQL

            string sql = "INSERT INTO Employees " +
                "(Name, Department, Designation, Company, CityId)" +
            ...
            using ( var con = new SqlConnection(_configuration.Value))
            {
                ...
                await con.ExecuteAsync(sql,newEmp);
